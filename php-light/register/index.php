...
<label>Username <input name="username" required autocomplete="username" minlength="3" maxlength="32" pattern="[A-Za-z0-9_.-]+"></label>
<label>Email <input name="email" type="email" autocomplete="email" maxlength="320"></label>
<label>Password <input name="password" type="password" required autocomplete="new-password" minlength="8" maxlength="1024"></label>
<label>Repeat password <input name="repeat" type="password" required autocomplete="new-password" minlength="8" maxlength="1024"></label>
...
const formStartedAtMs=Date.now();
